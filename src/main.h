...
void Sprite_animation(GLuint texture, int n, Hero *obj) {
    ...
    static float spriteXsize = 1001;
    static float spriteYsize = 245;
...
void Main_Init() {
    ...
    Load_Texture("Phineas.png", &sprite, GL_CLAMP, GL_CLAMP, GL_NEAREST);
    Load_Texture("fon1.png", &background, GL_REPEAT, GL_CLAMP, GL_NEAREST);
}
